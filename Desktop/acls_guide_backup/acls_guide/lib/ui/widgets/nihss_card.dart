    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            '📊 Classificação NIHSS — Referência',
            style: GoogleFonts.inter(
              fontSize: 12,
              fontWeight: FontWeight.w700,
              color: AppColors.textSecondary,
          ...
          const SizedBox(height: 8),
          _ReferenceRow(label: '0', desc: 'Sem déficit / TIA', color: AppColors.secondary, isHighlighted: total == 0, onTap: isStudyMode ? () => onSimulateScore?.call(0) : null),
          _ReferenceRow(label: '1–4', desc: 'AVC leve', color: AppColors.info, isHighlighted: total >= 1 && total <= 4, onTap: isStudyMode ? () => onSimulateScore?.call(2) : null),
          _ReferenceRow(label: '5–15', desc: 'AVC moderado', color: AppColors.warning, isHighlighted: total >= 5 && total <= 15, onTap: isStudyMode ? () => onSimulateScore?.call(10) : null),
          _ReferenceRow(label: '16–20', desc: 'AVC moderado-grave', color: AppColors.danger, isHighlighted: total >= 16 && total <= 20, onTap: isStudyMode ? () => onSimulateScore?.call(18) : null),
          _ReferenceRow(label: '21–42', desc: 'AVC grave', color: AppColors.danger, isHighlighted: total >= 21, onTap: isStudyMode ? () => onSimulateScore?.call(25) : null),
        ],
      ),
    );
  }
