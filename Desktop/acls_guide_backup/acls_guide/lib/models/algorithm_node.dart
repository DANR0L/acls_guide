...
class DrugInfo {
  ...
  // Campos enriquecidos — usados na Biblioteca de Fármacos
  final String category;             // Ex: 'Vasopressores', 'Antiarrítmicos'
  final List<String>? indications;   // Indicações clínicas
  final String? contraindications;   // Contraindicações relevantes
  ...
  const DrugInfo({
    ...
    this.notes,
    required this.color,
    this.category = 'Outros', // padrão para manter compatibilidade com algoritmos
    this.indications,
