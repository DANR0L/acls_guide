...
final tachycardiaAlgorithm = Algorithm(
  ...
  nodes: {
    ...
    'tachy_unstable': const AlgorithmNode(
      id: 'tachy_unstable',
      type: NodeType.action,
      title: 'Cardioversao Sincronizada - IMEDIATA',
      alertLevel: 'danger',
      bullets: [
        'SEDOANALGESIA (se tempo permitir, NAO atrasar cardioversao):',
        '   - Midazolam 2-5 mg IV (0,02-0,1 mg/kg) + Fentanil 50-100 mcg IV',
        '   - Alternativas: Propofol 0,5-1 mg/kg IV ou Etomidato 0,2 mg/kg IV',
        '   - Manter material de via aerea e BVM prontos',
        '',
        'TECNICA DE CARDIOVERSAO:',
        '   1. Confirmar SYNC ativado no monitor (verificar marcadores nos QRS)',
        '   2. Posicionar pas: anteroposterior (preferencial) ou anterolateral',
        '   3. Afastar todos do paciente antes do choque',
        '   4. Manter botao pressionado ate disparar (ha atraso pelo sync)',
        '',
        'ENERGIA INICIAL POR ARRITMIA (AHA 2025):',
        '   - FA: >= 200 J bifasico (iniciar na energia maxima)',
        '   - Flutter Atrial: 200 J bifasico (AHA 2025 padronizou)',
        '   - TSV/TRNAV: 50-100 J bifasico (escalonar se necessario)',
        '   - TV monomorfica com pulso: 100 J bifasico',
        '',
        'ATENCAO - TV POLIMORFICA / TORSADES:',
        '   - Tratar como FV: DESFIBRILACAO (modo NAO sincronizado)',
        '   - Energia: 200 J bifasico (dose de desfibrilacao)',
        '   - Sincronismo pode falhar (QRS aberrantes enganam o monitor)',
        '',
        'Se falhar o 1o choque: escalonar energia e verificar contato das pas',
      ],
    ...
    'tachy_post_cardioversion': const AlgorithmNode(
      ...
      alertLevel: 'success',
      bullets: [
        'MONITORIZACAO POS-CARDIOVERSAO:',
        '   - ECG 12 derivacoes imediatamente',
        '   - Monitorizacao continua por pelo menos 2-4 horas',
        '   - PA, FC, SpO2 a cada 15 min na 1a hora',
        '',
        'INVESTIGAR CAUSA DE BASE:',
        '   - Eletrolitos: K+ (manter > 4,0), Mg2+ (manter > 2,0), Ca2+',
        '   - Funcao tireoidiana (hipertireoidismo)',
        '   - Ecocardiograma (funcao VE, valvulopatias)',
        '   - Troponina se suspeita de SCA',
        '',
        'ANTICOAGULACAO (se FA/Flutter):',
        '   - CHA2DS2-VASc >= 2 (homens) ou >= 3 (mulheres): anticoagular',
        '   - DOAC preferencial (Apixaban, Rivaroxaban, Edoxaban, Dabigatrana)',
        '   - Manter anticoagulacao por minimo 4 semanas apos cardioversao',
        '',
        'PROFILAXIA DE RECORRENCIA:',
        '   - FA/Flutter: considerar antiarritmico de manutencao',
        '   - Consulta com cardiologista/eletrofisiologista eletiva',
        '   - Avaliar indicacao de ablacao por cateter',
      ],
    ),
    ...
    'tachy_refractory': const AlgorithmNode(
      id: 'tachy_refractory',
      type: NodeType.action,
      title: 'Cardioversao Refrataria',
      alertLevel: 'danger',
      bullets: [
        'DEFINICAO: Persistencia da arritmia apos >= 1 choque sincronizado adequado.',
        '',
        'PASSO 1 - OTIMIZAR O CHOQUE:',
        '   - Aumentar energia para MAXIMO do desfibrilador (tipicamente 360 J monofasico / 200 J bifasico)',
        '   - Trocar posicao das pas: se anterolateral, mudar para anteroposterior',
        '   - Verificar e melhorar contato das pas (gel, pressao firme)',
        '   - Aplicar tecnica de dupla cardioversao sequencial (double sequential) se disponivel 2 desfibriladores',
        '',
        'PASSO 2 - ANTIARRITMICO IV ANTES DE NOVA TENTATIVA:',
        '   A escolha depende do tipo de arritmia:',
        '',
        '   FA/Flutter refratarios:',
        '     - 1a opcao: Amiodarona 150 mg IV em 10 min',
        '     - 2a opcao: Procainamida 20 mg/min IV (max 17 mg/kg)',
        '     - Em Torsades/hipoMg: Sulfato de Magnesio 2 g IV em 10 min',
        '',
        '   TSV refrataria (pos-adenosina e pos-choque):',
        '     - Diltiazem 20 mg IV em 2 min (se nao houver hipotensao)',
        '     - Ou Verapamil 5 mg IV em 2 min',
        '',
        '   TV monomorfica refrataria:',
        '     - 1a opcao: Amiodarona 150 mg IV em 10 min',
        '     - 2a opcao: Lidocaina 1-1,5 mg/kg IV em bolus',
        '     - 3a opcao: Procainamida 20 mg/min IV',
        '',
        '   TV polimorfica / Torsades (QT longo):',
        '     - MgSO4 2 g IV em 2-5 min (1a linha obrigatoria)',
        '     - Isoproterenol ou overdrive pacing se bradicardia-dependente',
        '     - NAO usar amiodarona (prolonga QT e piora Torsades)',
        '',
        'PASSO 3 - REPETIR CARDIOVERSAO:',
        '   - Aguardar 10-15 min apos infusao do antiarritmico',
        '   - Repetir choque na energia maxima com posicao otimizada',
        '   - Maximo 3 tentativas de cardioversao antes de reavaliar estrategia',
        '',
        'PASSO 4 - SE AINDA REFRATARIO:',
        '   - Consulta eletrofisiologista URGENTE',
        '   - Considerar controle de frequencia e aceitar a arritmia',
        '   - Excluir causas reversiveis: hipocalemia, hipomagnesemia, hipertireoidismo, isquemia',
        '   - UTI para monitorizacao e infusao continua de antiarritmico',
      ],
    ...
    'amio_cardioversion': const AlgorithmNode(
      ...
      type: NodeType.drug,
      title: 'Amiodarona - Cardioversao Refrataria',
      drug: DrugInfo(
        name: 'Amiodarona',
        dose: '150 mg diluidos em 100 mL de SG 5%',
        route: 'IV em 10 minutos (bomba de infusao)',
        frequency: 'Pode repetir 150 mg IV a cada 10 min (max 6 doses). Apos controle: manutencao 1 mg/min por 6h, depois 0,5 mg/min por 18h.',
        maxDose: 'Max 2,2 g em 24h',
        notes: 'CUIDADOS: (1) Usar acesso venoso central ou veia calibrosa (flebite se periferico). (2) Monitorar PA (hipotensao e bradicardia). (3) Apos infusao do antiarritmico, aguardar 10-15 min e REPETIR cardioversao eletrica na energia maxima com pas em posicao anteroposterior. (4) Se TV polimorfica com QT longo (Torsades): NAO usar amiodarona - preferir MgSO4 2 g IV.',
        color: '#A855F7',
      ),
      nextNodeId: 'tachy_qrs_width',
    ),
