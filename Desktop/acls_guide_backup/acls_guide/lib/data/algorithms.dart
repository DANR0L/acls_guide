  ...
  nodes: {
    ...
    'amio_cardioversion': const AlgorithmNode(
      ...
      drug: DrugInfo(
        ...
        dose: '150 mg',
        route: 'IV em 10 min',
        frequency: 'Repetir se necessário. Iniciar manutenção: 1 mg/min por 6h e 0,5 mg/min nas 18h seguintes.',
    ...
    'afib_rate_control': const AlgorithmNode(
      ...
      subtitle: 'Drogas em ordem de preferência (ACC/AHA 2023)',
      alertLevel: 'info',
      bullets: [
        ...
        '   • Esmolol 500 mcg/kg IV em 1 min → infusão 50–200 mcg/kg/min (ultra-curto, ideal p/ titular)',
        '   ⚠️ CI: IC descompensada, asma/DPOC grave, BAV 2–3º, bradicardia, cocaína',
        '',
        '🥇 1ª LINHA — BCC não-dihidropiridinícos:',
        '   • Diltiazem 0,25 mg/kg IV em 2 min (repetir 0,35 mg/kg após 15 min) → manutenção 5–15 mg/h',
        '   • Verapamil 5–10 mg IV em ≥2 min (repetir 1x após 15 min) → infusão 5 mg/h (máx 20 mg/h)',
        '   ⚠️ CI: IC com FE reduzida (efeito inotrópico negativo), hipotensão, BAV',
        ...
        '   ⚠️ CI: hipocalemia (potencializa toxicidade), insuficiência renal (ajustar)',
        '',
        '🥉 3ª LINHA — Amiodarona (reserva):',
        '   • Amiodarona 150 mg IV em 10 min → 1 mg/min por 6h → 0,5 mg/min por 18h',
        '   • Usar APENAS se BB, BCC e Digoxina falharem ou forem contraindicados',
        '   • Tem efeito de controle de ritmo e frequência',
        '   ⚠️ CI: QT longo, doença tireoidiana, hepatopatia, bradicardia',
        '   ⚠️ Efeitos adversos: hipotensão, bradicardia, toxicidade pulmonar/tireoidiana/hepática',
        '',
        '📋 ANTICOAGULAÇÃO obrigatória ≥ 3 semanas antes de cardioversão eletiva',
